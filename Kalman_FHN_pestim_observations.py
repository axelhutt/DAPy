...
import Kalman_FHN_pestim_params as params
...
class Observations(params.Kalman):
    def initialize(self):
        ...
        self.xbt[2,0]    = -1.5
        self.xbt[3,0]    = 0.0
        self.xbt[4,0]    = self.I_1_true
        self.xbt[5,0]    = self.tau_2_true
    ...
    def generate_observations(self):
        ...
        self.xbt_false[4,0] = self.I_1_false
        self.xbt_false[5,0] = self.tau_2_false
