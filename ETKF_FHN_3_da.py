...
import ETKF_FHN_3_params as params
...
class da(params.Kalman):
    ...
    def Compute_prediction(self):
      ...
      self.X[:self.dim_model,:] += \
                        np.random.normal(0.0,1.0,(self.dim_model,self.L))*self.addcovinfl  
      self.X[self.dim_model:self.dim_state,:] += \
                        np.random.normal(0.0,1.0,(self.dim_state-self.dim_model,self.L))*self.Q2  
