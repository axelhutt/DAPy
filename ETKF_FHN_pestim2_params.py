...
class Kalman:
	def __init__(self):
		...
		self.L		 	   	= 5 # number of ensemble members
	...
	def model_system(self, b0_1, b1_1, tau_1, I_1, b0_2, b1_2, tau_2, I_2,noise1,noise2,noise3):
		...
		#tau1 = 0.5*(self.tau_1_max-self.tau_1_min)*np.tanh(xp4)
		#rhythm2
		#tau2 = self.parameter_function_tau2(self.x[5])
		#I2 = self.parameter_function_I1(self.x[5])
