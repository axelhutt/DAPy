...
class Kalman:
	def __init__(self):
		...
		self.label_reconstr_state_ens 	= self.filename+'ETKF_FHN_bg_reconstructed_ens'
		

		self.num_time     	= 2000#500  # number of observation times = number of DA cycles
		self.num_time_switch = self.num_time//2
		...
		self.dim_obs       	= 2
		self.num_params    	= 0 # number of model parameters to be estimated 
	...
	def initialize_basic(self):
		...
		self.I_1_s_true   = 1.5
		self.b0_1_s_true  = 2.0
		self.b1_1_s_true  = 1.3
		self.tau_1_s_true = 5.0#10.0
		# false model
		self.I_1_false     = 2.0 # different parameter
		self.b0_1_false    = 2.0
		self.b1_1_false    = 1.3
		...
		self.I_2_s_true   = 5.0#1.5
		self.b0_2_s_true  = 2.0
		self.b1_2_s_true  = 15.0#10.0
		self.tau_2_s_true = 5.0#10.0
		# false model		
		self.I_2_false     = 1.5
		self.b0_2_false    = 2.0
		...
		self.addcovinfl			= 0.012 # additive covariance inflation
		self.multensinfl			= 1.000 # multiplicative ensemble inflation factor
